...
router.post("/after-sales/:id/cancel", AfterSalesController.cancel)
...
router.get("/shipping/:schoolId/history-summary", auth, ShippingController.getHistorySummary)
router.get("/shipping/batch/:batchId/export", auth, ShippingController.exportHistoricalManifest)
